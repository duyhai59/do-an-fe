...
@Component({
  selector: 'app-list-news-categories',
  templateUrl: './list-news-categories.component.html',
  styleUrls: ['./list-news-categories.component.scss'],
})

export class ListNewsCategoriesComponent implements OnInit {
  files2: TreeNode[];
  cols: any[];
